...
public class StudentController {
    ...
    @PostMapping(path= "/student")
  	public StudentVO getStudent1(@RequestParam(name= "name") String name1) {
      	System.out.println("name ="+ name1);
      	return null;
      }
    ...
    @GetMapping(path= "/student/{rollnum}")
   	public StudentVO getStudent3(@RequestParam(name= "name") String name1, @PathVariable(name= "rollnum") String rollnum) {
    ...
    @PostMapping(path= "/student/{rollnum}/V2")
   	public StudentVO getStudent4(
    	...
    	return service.getStudent4(name1, rollnum, student);
       }
  ...
  @DeleteMapping(path= "/student")
	public StudentVO getStudent6(@RequestParam(name= "name") String name1) {
  	System.out.println("name ="+ name1);
