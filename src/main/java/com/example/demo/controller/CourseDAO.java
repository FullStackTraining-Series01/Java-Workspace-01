...
public class CourseDAO {
	...
	public Student getStudent()
	{
		...
		Optional<StudentEntity> studentEntityOptinal= myjpa.findById("Lakshmi");
		 
		StudentEntity studententity=  studentEntityOptinal.get();
	...
	public Student getStudent(String name)
	{
		...
		Optional<StudentEntity> studentEntityOptinal= myjpa.findById(name);
