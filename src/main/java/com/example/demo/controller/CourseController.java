...
public class CourseController {
	...
	/*
	 * /mycourse/{name}, parameter @PathVariable name --> name is Path Variable									--> mycouse/Ajay
	 *  /mycourse, parameter @RequestParam name --> name is RequestParam Variable								--> mycourse?name=Ajay
	 * */
	
	@GetMapping("/mycourse/{name}")
	public Student getCourse(@PathVariable(name = "name") String name){
